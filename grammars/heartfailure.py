...
#Heartfailure Grammar with time (after normalization and multiplication to remove negative and float values)
HEARTFAILURE: Grammar = {
	"<start>": ["<age> <anaemia> <creatinine_phosphokinase> <diabetes> <ejection_fraction> <high_blood_pressure> <platelets> <serum_creatinine> <serum_sodium> <sex> <smoking> <time>"],
